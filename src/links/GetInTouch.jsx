export default function GetInTouch(){
    return(
        <>
        <section class="bg-white dark:bg-black mt-12">
  <div class="lg:py-16 px-4 mx-auto max-w-screen-md">
      <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-center text-gray-900 dark:text-white">Send A Message</h2>
      <p class="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">I'm always looking for opportunities to work on backend projects, let me know!</p>
      <form action="https://formsubmit.co/cobraxcodes@gmail.com" method="POST" class="space-y-8">
          <div>
